...
export const post: BlogPost = {
  ...
  date: '2024-12-13',
  datetime: '2024-12-13-10-00',
  title: 'Wat helpt écht tegen rimpels?',
  titleEn: 'What really helps against wrinkles?',
  excerpt: 'Veel mensen willen weten hoe ze rimpels kunnen voorkomen en wat ze kunnen doen tegen bestaande rimpels. Er zijn verschillende dingen die je zelf kunt doen.',
  excerptEn: 'Many people want to know how to prevent wrinkles and what they can do about existing wrinkles. There are several things you can do yourself.',
